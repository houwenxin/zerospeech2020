...
@LastEditors  : houwx
@LastEditTime : 2020-01-31 15:04:07
@Description: 
'''
import time
...
seed = 1234
#torch.manual_seed(1) # 1 VQVAE + MelGAN before model-melgan-937-441-414153-False.pt
...
if __name__ == "__main__":
    ...
    if args.load_vqvae:
        ...
        vqvae_model = ckpt_path + "model-vqvae-9367-148-1395682-True.pt"
